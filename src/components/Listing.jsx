                                                ...
                                                <div className="inside-div" onClick={() => handleDetailsPage(pokemon)}>
                                                    ...
                                                    <div className="pokemon-info">
                                                        <div style={{ display: "flex" }}>
                                                            <h4>Nom : </h4><span>&nbsp;{capitalizeFirstLetter(pokemon.name)}</span>
                                                        </div>
                                                    </div>
                                                    <div className="pokemon-info">
                                                        <div style={{ display: "flex" }}>
                                                            <h4>Poids : </h4><span>&nbsp;{pokemon.weight / 10} (Kg)</span>
                                                        </div>
                                                        <div style={{ display: "flex" }}>
                                                            <h4>Taille : </h4><span>&nbsp;{pokemon.height / 10} (m)</span>
                                                        </div>
                                                    </div>
													<div className="title">
														  <div style={{ display: "flex" }}>
															<h4>Types : </h4><span>&nbsp;</span>
														  </div>
                                                        <span>
                                                             {
